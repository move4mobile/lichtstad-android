 ...
 *
 * This is basically {@link android.support.v7.widget.LinearSnapHelper} with some changes to make the scroll snap to the next page.
 */
public class SinglePageLinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager,
        ...
        float result = distance / distancePerChild;
